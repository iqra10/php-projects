...
<p>
    ...
    <input class="widefat" id="<?php echo $this->get->field_id('title'); ?>" name="<?php echo $this->get->field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
</p>

<p>
    <label for="<?php echo $this->get_field_id('recipient'); ?>"><?php __e('Recipient:'); ?></label>
    <input class="widefat" id="<?php echo $this->get->field_id('recipient'); ?>" name="<?php echo $this->get->field_name('recipient'); ?>" type="text" value="<?php echo esc_attr($recipient); ?>" />
</p>

<p>
    <label for="<?php echo $this->get_field_id('subject'); ?>"><?php __e('Subject:'); ?></label>
    <input class="widefat" id="<?php echo $this->get->field_id('subject'); ?>" name="<?php echo $this->get->field_name('subject'); ?>" type="text" value="<?php echo esc_attr($subject); ?>" />
</p>
...
*/   
 ...
 public function getForm($recipient, $subject) {
     ...
     $output = printf('
             ...
             <form id="ajax-contact" method="post" action="%s/contact-widget/mailer.php">
             <div class="field">
             ...
             <input name="recipient" type="hidden" value="%s" />
